        ...
        <div>
            <div className="flex flex-col items-center py-16">
                <div className="h-32 w-32">
                    ...
                    >
                        <div className="h-full w-full rounded-md bg-gray-300 shadow-lg flex justify-center items center" >
                            <div>
                                <SiShopee size={100} className='flex justify-center items center mt-3 text-orange-500' />
                            </div>
                        </div>
                    </Transition>
                </div>
